...
app.use('/api/tipoFactura', require('./routes/tipoFactura'))
...
app.use('/api/solicitudViajes', require('./routes/solicitudViaje'))
...
app.use('/api/tipoTransporte', require('./routes/tipoTransporte'))
app.use('/api/tipoSolicitudViaje', require('./routes/tipoSolicitudViaje'))
...
app.use('/api/concepto-loop', require('./routes/conceptoLoop'))
...
app.use('/api/tipoSolicitudViajes', require('./routes/tipoSolicitudViaje'))
